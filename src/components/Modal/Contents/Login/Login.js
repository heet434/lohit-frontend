  ...
  return (
    <div className='user-login' id='login'>
        <div className = 'login-container'>
            {/* r1 */}
            <div className='modal-close login-r1' onClick={props.closeModal}>
            ...
            <div className='login-r1 modal-title'>
            ...
            {/* r2 */}
            <div className='login-r2 login-input-container'>
                <div className='login-input'>
                    <input type='email' placeholder='Email' value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
            </div>
            {/* r3 */}
            <div className='login-r3 login-input-container'>
                <div className='login-input'>
                    <input type='password' placeholder='Password' value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
            </div>
            {/* r4 */}
            <div className='login-r4 forgot-password'>
                Forgot Password?
            </div>
            {/* r5 */}
            <div className='login-r5 login-button'>
                Login
            </div>
            {/* r6 */}
            <div className='login-r6 login-signup'>
